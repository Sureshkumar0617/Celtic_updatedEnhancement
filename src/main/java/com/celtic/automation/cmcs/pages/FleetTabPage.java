...
public class FleetTabPage {
	...
	public void selectEffectiveDate(String effDate) {
		...
		if(valueexists==true) {
			ElementUtil.highlightElement(driver, fleetDetailsFltEffDatedtPicker);
	...
	public void selectExpirationDate(String expDate) {	
			ElementUtil.clearElement(fleetDetailsFltExpDatedtPicker);
...
public boolean fleetServicePowerOfAttroneyLblpresence() {
	return ElementUtil.isPresentAndDisplayed(fleetServicePowerOfAttroneyLbl);
}
...
public void scrollToFax() {
	ElementUtil.scrollIntoView(fleetDetailsFaxNoLbl);
}
...
public void scrollToAddrOnUsdot() {
	ElementUtil.scrollIntoView(fleetDetailsChangeAddrOnUsdotLbl);
}
...
public boolean fleetHVUTFormLblpresence() {
	return ElementUtil.isPresentAndDisplayed(fleetVehDocumentHVUTFormLbl);
}
...
public boolean fleetPropertyTaxLblpresence() {
	return ElementUtil.isPresentAndDisplayed(fleetVehDocumentPropertyTaxLbl);
}
