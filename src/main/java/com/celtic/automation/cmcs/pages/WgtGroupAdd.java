...
public class WgtGroupAdd {
	...
	@FindBy(xpath="//label[@for='WgtGroupNoOld']") WebElement addWgtGroupCopyFromWeightLbl;
	@FindBy(xpath="//input[@id='WgtGroupNoOld']") WebElement addWgtGroupCopyFromWeightTxt;
	@FindBy(xpath="//input[@id='btnCopyFrom']") WebElement addWgtGroupCopyFromBtn;



	@FindBy(xpath="(//div[contains(@class,'box-title')]/h4)[2]") WebElement addWgtGroupListOfJurandWeightSubHdr;
	@FindBy(xpath="//input[contains(@id,'WeightList') and contains(@id,'WeightQ')]") List<WebElement> addWgtGroupWeightTxt;
